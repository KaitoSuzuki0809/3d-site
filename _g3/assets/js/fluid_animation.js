...
(function(w) {
    ...
    */
    ...
    var canvas_width = 1980; //Needs to be a multiple of the resolution value below.
    var canvas_height = 1980; //This too.
    ...
    var speck_count = 8000; //This determines how many particles will be made.
    ...
    */
    function init() {
        ...
        */
        ...
        // w.addEventListener("mousemove", touch_start_handler);

        // w.addEventListener("mousemove", mouse_up_handler);
        // w.addEventListener("mousemove", touch_end_handler);

        // canvas.addEventListener("mousemove", mouse_move_handler);
        // canvas.addEventListener("mousemove", touch_move_handler);
